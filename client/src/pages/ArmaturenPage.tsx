...
export default function ArmaturenPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO 
        title="Wasserhahn tropft? Armaturen Service München ab 80€"
        description="Tropfender Wasserhahn nervt und kostet Wasser? Wir reparieren oder tauschen Ihre Armatur. Festpreis ab 80€. Schnell und sauber."
              ...
              <div className="relative space-y-4">
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="bg-secondary/10 rounded-xl p-4 flex flex-col justify-center">
                    <div className="text-2xl font-bold text-secondary">ab 80€</div>
                    <div className="text-sm text-muted-foreground">Festpreis Montage</div>
                  </div>
                </div>
              </div>
            </div>

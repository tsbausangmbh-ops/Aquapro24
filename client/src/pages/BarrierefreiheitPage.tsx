  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        ...
        keywords="Barrierefreiheit, WCAG, BITV, Accessibility, barrierefrei, Sanitär München"
      />
      <Header />

      <main id="main-content" className="max-w-4xl mx-auto px-4 lg:px-8 py-12">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <Accessibility className="w-10 h-10 text-primary" aria-hidden="true" />
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground">
                ...
                und zuletzt am <strong>22. Dezember 2025</strong> überprüft.
              </p>
            </CardContent>
          </Card>
        </section>

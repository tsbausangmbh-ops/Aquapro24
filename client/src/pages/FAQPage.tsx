...
const pricingCategories = [
  {
    ...
    items: [
      { service: "Wasserhahn Reparatur", price: "ab 240€" },
      { service: "Tropfender Wasserhahn", price: "ab 240€" },
      { service: "WC-Spülung Reparatur", price: "ab 370€" },
      { service: "Siphon austauschen", price: "ab 77€" },
      { service: "Abfluss reinigen", price: "ab 115€" },
      { service: "Rohrbruch Notdienst", price: "ab 195€" },
    ]
  },
  {
    icon: ShowerHead,
    title: "Badsanierung",
    items: [
      { service: "Komplettes Bad (klein)", price: "ab 11.600€" },
      { service: "Komplettes Bad (mittel)", price: "ab 18.900€" },
      { service: "Komplettes Bad (groß)", price: "ab 28.600€" },
      { service: "Dusche erneuern", price: "ab 3.800€" },
      { service: "Badewanne einbauen", price: "ab 2.350€" },
      { service: "Barrierefreies Bad", price: "ab 26.000€" },
    ]
  },
  {
    icon: Flame,
    title: "Heizung",
    items: [
      { service: "Heizungswartung", price: "ab 195€" },
  ...
  },
  {
    ...
    title: "Wärmepumpe",
    items: [
      { service: "Luft-Wasser-WP (klein)", price: "ab 15.600€" },
      { service: "Luft-Wasser-WP (groß)", price: "ab 23.400€" },
      { service: "Erdwärmepumpe", price: "ab 58.500€" },
      { service: "WP-Wartung jährlich", price: "ab 360€" },
...
export default function FAQPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <Header />
      <main>
        <section className="relative py-10 lg:py-6 bg-gradient-to-br from-primary/10 via-background to-secondary/5">
        ...
        <section className="py-6 lg:py-6 bg-muted/30">
          <div className="max-w-7xl mx-auto px-4 lg:px-8">

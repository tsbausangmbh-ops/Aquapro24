...
export default function HaustechnikPage() {
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title="Haustechnik München | Wasser, Gas & Lüftung | AquaPro24"
        description="Haustechnik München: Wasser, Gas, Lüftung, Smart Home aus einer Hand. 500+ Projekte, zertifiziert. Beratung: 0152 12274043"

...
export default function HaustechnikPage() {
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title="Komplette Haustechnik aus einer Hand | München"
        description="Kein Handwerker-Chaos mehr. Wasser, Gas, Lüftung, Smart Home - ein Ansprechpartner für alles. Koordiniert und stressfrei."

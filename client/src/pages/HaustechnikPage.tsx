...
export default function HaustechnikPage() {
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title="Haustechnik München: Wasser, Gas, Lüftung komplett"
        description="Mehrere Handwerker koordinieren ist stressig? Bei uns bekommen Sie alles aus einer Hand: Wasser, Gas, Lüftung, Smart Home. Ein Ansprechpartner."

...
export default function Home() {
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title="Sanitär & Heizung München | 24/7 Notdienst | AquaPro24"
        description="AquaPro24 München: Sanitär, Heizung & Badsanierung seit 2005. 24/7 Notdienst, Festpreisgarantie, 2.800+ Kunden. Jetzt anrufen: 0152 12274043"

...
export default function Impressum() {
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Impressum | Sanitär & Heizung München | § 5 DDG"
        description="Impressum gemäß § 5 DDG: Mustafa Sakar, Hardenbergstr. 4, 80992 München. Sanitär & Heizung Partnernetzwerk."

...
export default function RatgeberPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <Header />
      <main>
        <section className="relative py-10 lg:pt-6 pb-6 bg-gradient-to-br from-accent/10 via-background to-primary/5">
        ...
        {guides.map((guide, guideIndex) => (
          <section 
            key={guide.id} 
            id={guide.id} 
            className={`pt-6 pb-6 lg:pt-8 lg:pb-8 ${guideIndex % 2 === 1 ? 'bg-muted/30' : ''}`}
          >
            <div className="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <section className="py-6 lg:pt-6 pb-6 bg-secondary text-secondary-foreground">

...
export default function RohrreinigungPage() {
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title={seoMeta['/rohrreinigung'].title}
        description={seoMeta['/rohrreinigung'].description}
        canonical="https://aquapro24.de/rohrreinigung"
        keywords={seoMeta['/rohrreinigung'].keywords.join(', ')}
        breadcrumbs={[
      ...
      <main id="main-content">
        ...
        <section className="py-4 sm:py-6 lg:py-8">
          <div className="max-w-7xl mx-auto px-4 lg:px-8">
            <div className="text-center mb-10">
              <h2 className="text-lg sm:text-xl lg:text-3xl font-bold mb-3">AquaPro 24 Rohrreinigung München: Preise & Services</h2>
        ...
        <section className="py-4 sm:py-6 lg:py-8 bg-muted/30">
          <div className="max-w-7xl mx-auto px-4 lg:px-8">
            <div className="text-center mb-10">
              <h2 className="text-lg sm:text-xl lg:text-3xl font-bold mb-3">Abfluss Ablauf München: So einfach geht's</h2>
              <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto">
        ...
        <section className="py-4 sm:py-6 lg:py-8">
          <div className="max-w-7xl mx-auto px-4 lg:px-8">
            <div className="text-center mb-10">
              <h2 className="text-lg sm:text-xl lg:text-3xl font-bold mb-3">AquaPro 24 Rohrreinigung Garantie München: Unser Versprechen</h2>

...
export default function RohrreinigungPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO 
        title="Rohrreinigung München | Abfluss verstopft? | Ab 79€"
        description="Abfluss verstopft München? Rohrreinigung Notdienst: Küche, Dusche, WC. Hochdruckspülung, Kamerainspektion. 60 Min. vor Ort."

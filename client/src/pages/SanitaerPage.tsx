  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <section className="relative py-6 md:pt-6 pb-6 bg-gradient-to-br from-secondary/10 via-background to-accent/5">
        ...
        <section className="py-10 md:pt-6 pb-6 bg-muted/30">
          <div className="max-w-7xl mx-auto px-4 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
        ...
        <section className="py-10 md:pt-6 pb-6 bg-secondary text-secondary-foreground">

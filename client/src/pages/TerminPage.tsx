...
export default function TerminPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title={seoMeta['/termin'].title}
        description={seoMeta['/termin'].description}
        canonical="https://aquapro24.de/termin"
        keywords={seoMeta['/termin'].keywords.join(', ')}
      ...
      <main id="main-content">
          ...
          <div className="relative max-w-7xl mx-auto px-4 lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="text-sm sm:text-base lg:text-lg text-white/90 mb-1 sm:mb-3">
                <strong>Brauchen Sie einen Handwerker-Termin?</strong>
              </p>
              ...
              <div className="backdrop-blur-sm rounded-lg p-2 sm:p-3 mb-2 sm:mb-4 border" style={{ backgroundColor: "rgba(255,255,255,0.1)", borderColor: "rgba(255,255,255,0.2)" }}>
                <p className="text-white/90 text-sm">
                  <strong className="text-accent">Stellen Sie sich vor:</strong> Sie buchen Ihren Wunschtermin online – und der Handwerker kommt pünktlich, mit Festpreis und allem Material.
                </p>
              </div>

              <p className="text-sm sm:text-base text-white/80 mb-3 sm:mb-6">
                <strong>2.847 Münchner Familien</strong> buchen online – Festpreise: Sanitär ab 92€ | Rohrreinigung ab 81€ | Heizung ab 154€
              </p>

              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mb-3 sm:mb-6">
                <Button size="lg" className="gap-2 text-base" asChild data-testid="button-call-termin">
        ...
        <section className="py-4 sm:py-6 lg:py-8">
          <div className="max-w-3xl mx-auto px-4 lg:px-8">
            <h2 className="text-lg sm:text-xl lg:text-3xl font-bold mb-4 sm:mb-6 text-center">AquaPro 24 Termin online München: Wunschtermin in Echtzeit buchen</h2>

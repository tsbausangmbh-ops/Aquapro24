...
export default function UeberUnsPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        {/* Hero Section */}
        <section className="relative pt-6 pb-6 lg:pt-8 lg:pb-8">
        ...
        {/* Values Section */}
        <section className="py-10 lg:pt-6 pb-6 bg-secondary/5">
          <div className="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <section className="py-10 lg:pt-6 pb-6 bg-muted/30">
          <div className="max-w-7xl mx-auto px-4 lg:px-8">
            <div className="text-center mb-12">
        ...
        {/* CTA Section */}
        <section className="py-10 lg:pt-6 pb-6 bg-primary text-primary-foreground">

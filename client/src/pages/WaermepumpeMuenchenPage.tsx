...
export default function WaermepumpeMuenchenPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
          ...
          <div className="relative max-w-7xl mx-auto px-4 lg:px-8">
            <div className="max-w-3xl">
              ...
              <div className="sr-only" data-testid="keyword-cloud">
                ...
                <span className="inline-flex px-2 py-0.5 text-xs rounded-md bg-white/10 text-white/80 border border-white/20">BAFA Förderung 2026</span>
      ...
      <InternalLinks
        title="Wärmepumpe & Heizungs-Services"
        variant="footer-cta"
        links={[
          { href: "/waermepumpe", text: "Wärmepumpe Leistungen", description: "Alle Details zur Installation" },
          ...
          { href: "/fussbodenheizung-muenchen", text: "Fußbodenheizung", description: "Ideal mit Wärmepumpe kombiniert" },

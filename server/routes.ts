  ...
  app.post("/api/ratgeber-download", async (req, res) => {
    try {
      ...
      await emailTransporter.sendMail({
        ...
        html: `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;"><div style="background: #f97316; padding: 30px; text-align: center;"><h1 style="color: white; margin: 0; font-size: 28px;">AquaPro 24</h1><p style="color: white; margin: 10px 0 0 0; font-size: 14px;">Ihr Partnernetzwerk in München</p></div><div style="padding: 20px 30px 30px 30px; background: #f9fafb;"><h2 style="color: #1f2937; margin: 0 0 15px 0; font-size: 20px;">Hallo ${name.trim()},</h2><p style="color: #4b5563; line-height: 1.6;">vielen Dank für Ihr Interesse an unserem <strong>Ratgeber Heizung &amp; Sanitär</strong>!</p><p style="color: #4b5563; line-height: 1.6;">Im Anhang finden Sie unseren kostenlosen Ratgeber mit 12 praktischen Tipps zu typischen Alltagsproblemen bei Heizung und Sanitär – verständlich erklärt, Schritt für Schritt.</p><div style="background: white; border-left: 4px solid #f97316; padding: 20px; margin: 20px 0;"><strong style="color: #1f2937;">Inhalt des Ratgebers (12 Tipps):</strong><ul style="color: #4b5563; margin: 10px 0; padding-left: 20px;"><li>Heizkörper gluckert oder wird nicht warm</li><li>Heizungsdruck zu niedrig – Anlage schaltet ab</li><li>Thermostat auf 5, aber Heizkörper bleibt kalt</li><li>Warmwasser schwankt oder wird nicht heiß</li><li>Wasserhahn tropft oder Abfluss läuft langsam</li><li>WC spült schwach oder läuft nach</li></ul></div><p style="color: #4b5563; line-height: 1.6;">Bei Fragen stehen wir Ihnen jederzeit zur Verfügung – rufen Sie uns einfach an: <strong>0152 12274043</strong></p><p style="color: #4b5563; line-height: 1.6;">Mit freundlichen Grüßen,<br><strong>Ihr AquaPro 24 Team</strong></p></div><div style="background: #fef2f2; padding: 20px; text-align: center; border-top: 3px solid #f97316;"><p style="color: #7c2d12; margin: 0; font-size: 14px;">AquaPro 24 | Hardenbergstr. 4 | 80992 München<br>Tel: 0152 12274043 | info@aquapro24.de | <a href="https://aquapro24.de" style="color: #ea580c;">aquapro24.de</a></p></div></div>`,
        attachments: [
          {
